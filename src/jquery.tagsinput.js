...
(function($) {
    ...
    $.fn.tagsInput.importTags = function(obj, val) {
        $(obj).val('');
        var id = $(obj).attr('id');
        var tags = _splitTags(val, delimiter[id]);
    ...
    var _splitTags = function(val, delimiter) {
        ...
        if (typeof delimiter === 'string') {
            ...
            var firstDelimiter = delimiters.shift();

            $.each(delimiters, function(index, delimiterTmp) {
                var valTmp = val;
                var regex = new RegExp('\\' + delimiterTmp, 'g');
                val = valTmp.replace(regex, firstDelimiter);
            });

            tags = val.split(firstDelimiter);
        }
